...
import com.serein.windoj.judge.JudgeService;
import com.serein.windoj.mapper.QuestionSubmitMapper;
...
public class QuestionSubmitServiceImpl extends ServiceImpl<QuestionSubmitMapper, QuestionSubmit>
    ...
    public QuestionSubmitVO getQuestionSubmitVO(QuestionSubmit questionSubmit, User loginUser) {
        ...
        if (!Objects.equals(loginUserId, submitUserId) && !userService.isAdmin(loginUser)) {
            questionSubmitVO.setCode(null);
        }
        // 由 提交用户id 转为 UserVO，这里直接调用数据库，下面page中则是在 HashMap 中取
        User submitUser = userService.getById(submitUserId);
        UserVO submitUserVO = userService.getUserVO(submitUser);
    ...
    public Page<QuestionSubmitVO> getQuestionSubmitVOPage(Page<QuestionSubmit> questionSubmitPage, User loginUser) {
        ...
        List<QuestionSubmitVO> questionSubmitVOList = questionSubmitList.stream().map(questionSubmit -> {
            ...
            questionSubmitVO.setUserVO(userService.getUserVO(user));  // 将 user 转换为 userVO
            return questionSubmitVO;
